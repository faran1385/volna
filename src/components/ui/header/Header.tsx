    ...
    return (
        <div className='Header-nav flex justify-end xl:static fixed top-0 w-full  '>
            <div className='Header-nav__box--xl relative  transition-all duration-150 flex xl:justify-end justify-end items-center '>
                <header className="xl:hidden absolute left-3 p-5 flex items-center  sidebar__header">
                    <img className="h-full sidebar__header__image" src="https://volna.volkovdesign.com/img/logo.svg" />
                </header>
                <div className='Header-nav__left w-auto lg:left-0 Header-nav__left--action   absolute  flex items-center ps-7'>
                    ...
                    <div style={{ backgroundColor: "var(--background)" }} className={`xl:w-auto xl:static  transition-all duration-500 flex gap-2 fixed z-40 w-full ${toggleSearch ? "top-4 " : "-top-36"}`}>
                        <SearchInput />
                ...
                <div className='Header-nav__controler pe-7 flex'>
                    ...
                    <a href="#" className="flex ps-8 w-fit sidebar__nav__link">
...
const SearchInput : React.FC = () => {
    return (
        <div className='Header-nav__searech flex justify-between py-2  px-5 items-center w-11/12  gap-2'>

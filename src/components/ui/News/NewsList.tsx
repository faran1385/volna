    ...
    return <>
        <section className="px-8">
            ...
            <div className="my-5 gap-8 grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-3">
                ...
                <Report title="Tom Grennan ‘breaks the internet’ as fans overload servers during virtual gig" href="" category="Music" timePassed={3} comments={18} img="https://volna.volkovdesign.com/img/posts/2.jpg" />
                <Report title="Why do the Golden Globes always get it so wrong?" href="" category="Features" timePassed={9} comments={54} img="https://volna.volkovdesign.com/img/posts/3.jpg"/>
            </div>
        </section>
    </>
}
        ...
        <aside ref={DivMenuRef} className={`sidebar transform-gpu xl:translate-x-0 -translate-x-full  `}>
            ...
            <nav className="overflow-y-auto w-full ps-8 sidebar__nav pt-2">
                <ul ref={Navigations}>
                    ...
                    <li className="my-5">
                        <a href="./artists" className="flex w-fit main-link"  id="sidebar-items-/artists">
                            <svg className="main-link__icon me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <li className="my-5">
                        <a href="./releases" className="flex w-fit main-link"  id="sidebar-items-/releases">
                            <svg className="main-link__icon me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <li className="my-5">
                        <a href="./events" className="flex w-fit main-link"  id="sidebar-items-/events">
                            <svg className="main-link__icon me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <li className="my-5">
                        <a href="./podcasts" className="flex w-fit main-link"  id="sidebar-items-/podcasts">
                            <svg className="main-link__icon me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <li className="my-5">
                        <a href="./store" className="flex w-fit main-link"  id="sidebar-items-/store">
                            <svg className="main-link__icon me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <li className="my-5">
                        <a href="./news" className="flex w-fit main-link"  id="sidebar-items-/news">
                            <svg className="main-link__icon me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">

...
export const Player = () => {
    ...
    return <>
        <div ref={player}
            className={`player ease-in transition-all duration-500 xl:translate-y-0 translate-y-full  transform-gpu xl:w-auto w-full ps-4 xl:ps-6 fixed bottom-0 p-4 flex flex-col justify-center`}>
        ...
        <div className="fixed w-full flex justify-center bottom-0 xl:hidden">

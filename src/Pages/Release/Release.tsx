...
export const Release: React.FC = () => {
    ...
    const {currentIndex, isPlaying} = useAppSelector(state => state.player)
    const editedSongs = useMemo(() => {
        return songs.map((song, i) => {
            return {...song, isActive: i + 1 === currentIndex, isPlaying: isPlaying && i + 1 === currentIndex}
        })
    ...
    return (
        <main className='pages pages--mobile'>
            <HeadPages title='Jason Aldean – Space Melody'
                       Items={[{text: "home", href: "/"}, {text: "releases", href: "./releases"}, {text: "release"}]}/>
            <ReleaseCard
                ...
                <div className=' lg:col-start-1 lg:col-end-3'>
                    <section className='pb-12 mb-12 release-border'>
                        ...
                        <p className='text-gary'>
                            ...
                            href="#" className='about-link'>suffered</a> alteration in some form, by injected humour, or
                    ...
                    <div className='grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-4'>
                        <div className='releases__cards__card  flex flex-col items-center'>
                            <div className='releases__cards__card__header relative'>
                                ...
                                <img loading='lazy' className='releases__cards__card__header__img absolute'
                                     src={'https://volna.volkovdesign.com/img/covers/cover1.jpg'} title='music play'/>
                                <div
                                    className='releases__cards__card__header__text absolute lg:hidden bottom-5 sm:flex hidden gap-x-3 items-center '>
                                    <span className='flex items-center flex-row-reverse'>13 <svg
                                        className='releases__cards__card__header__text__icon '
                                    ...
                                    <span className='flex items-center flex-row-reverse uppercase'>140K <svg
                                        className='releases__cards__card__header__text__icon '
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path
                                        d="M20,13.18V11A8,8,0,0,0,4,11v2.18A3,3,0,0,0,2,16v2a3,3,0,0,0,3,3H8a1,1,0,0,0,1-1V14a1,1,0,0,0-1-1H6V11a6,6,0,0,1,12,0v2H16a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h3a3,3,0,0,0,3-3V16A3,3,0,0,0,20,13.18ZM7,15v4H5a1,1,0,0,1-1-1V16a1,1,0,0,1,1-1Zm13,3a1,1,0,0,1-1,1H17V15h2a1,1,0,0,1,1,1Z"></path></svg> </span>
                                </div>
                                <a href={'#'} title={'play'}
                                   className='releases__cards__card__header__link flex justify-center items-center absolute '>
                            ...
                            <div
                                className='releases__cards__card__body mt-2 flex flex-col items-center text-ellipsis overflow-hidden w-full '>
                                <a href='#' className='releases__cards__card__body__name capitalize text-center'>Space
                                    Melody</a>
                        ...
                        <div className='releases__cards__card flex flex-col items-center'>
                            <div className='releases__cards__card__header relative'>
                                ...
                                <img loading='lazy' className='releases__cards__card__header__img absolute'
                                     src={'https://volna.volkovdesign.com/img/covers/cover2.jpg'} title='music play'/>
                                <div
                                    className='releases__cards__card__header__text absolute lg:hidden bottom-5 sm:flex hidden gap-x-3 items-center '>
                                    <span className='flex items-center flex-row-reverse'>13 <svg
                                        className='releases__cards__card__header__text__icon '
                                ...
                                <a href={'#'} title={'play'}
                                   className='releases__cards__card__header__link z-10 flex justify-center items-center absolute '>
                                    <svg className='releases__cards__card__header__link__icon'
                                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path
                                            d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"></path>
                            ...
                            <div
                                className='releases__cards__card__body mt-2 flex flex-col items-center text-ellipsis overflow-hidden w-full '>
                                <a href='#' className='releases__cards__card__body__name capitalize text-center'>Said
                                    Sum</a>
                                <span className='releases__cards__card__body__artist text-center'>
                        ...
                        <div className='releases__cards__card flex flex-col items-center'>
                            <div className='releases__cards__card__header relative'>
                                ...
                                <img loading='lazy' className='releases__cards__card__header__img absolute'
                                     src={'https://volna.volkovdesign.com/img/covers/cover3.jpg'} title='music play'/>
                                <div
                                    className='releases__cards__card__header__text absolute lg:hidden bottom-5 sm:flex hidden gap-x-3 items-center '>
                                    <span className='flex items-center flex-row-reverse'>13 <svg
                                        className='releases__cards__card__header__text__icon '
                            ...
                            <div
                                className='releases__cards__card__body mt-2 flex flex-col items-center text-ellipsis overflow-hidden w-full '>
                                <a href='#' className='releases__cards__card__body__name capitalize text-center'>I Love
                                    My Country</a>
                                <span className='releases__cards__card__body__artist text-center'>
                        ...
                        <div className='releases__cards__card flex flex-col items-center'>
                            <div className='releases__cards__card__header relative'>
                                ...
                                <img loading='lazy' className='releases__cards__card__header__img absolute'
                                     src={'https://volna.volkovdesign.com/img/covers/cover4.jpg'} title='music play'/>
                                <div
                                    className='releases__cards__card__header__text absolute lg:hidden bottom-5 sm:flex hidden gap-x-3 items-center '>
                                    <span className='flex items-center flex-row-reverse'>13 <svg
                                        className='releases__cards__card__header__text__icon '
                            ...
                            <div
                                className='releases__cards__card__body mt-2 flex flex-col items-center text-ellipsis overflow-hidden w-full '>
                                <a href='#' className='releases__cards__card__body__name capitalize text-center'>Toosie
                                    Slide</a>
                                <span className='releases__cards__card__body__artist text-center'>

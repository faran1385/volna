    ...
    return (
        <main className='about pages pages--mobile'>
            ...
            <div className='flex justify-center mb-16'>
                <a href="#"
                   className='rounded-xl mt-3 me-5  md:me-6 flex items-center justify-center text-center item__button font-medium uppercase item__button--green item__button--toBlack'>
                    sign in
                </a>
            </div>
